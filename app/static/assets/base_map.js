    ...
    $(document).on('change', '#situationBaseLayerSelect', function () {
        ...
        if ('url_info' in baseLayers[this.value]) {
            ...
            mapValues.baseLayerInfoControl.onAdd = function () {
                ...
                div.innerHTML = '<a type="button" class="btn btn-sm btn-info" style="color: whitesmoke" id="baseLayerInfo" data-toggle="tooltips" target="_blank" href="' + url + '" title="Informations relatives à la couche de fond">Infos</a>';
                return div
            };
