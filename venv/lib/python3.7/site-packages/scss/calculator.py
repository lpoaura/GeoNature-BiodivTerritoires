...
class Calculator(object):
    ...
    def __init__(
        self, namespace=None, ignore_parse_errors=False, undefined_variables_fatal=True,
    ):
        ...
        if not isinstance(cont, six.string_types):
            warn(
                FutureWarning(
                    ...
                    "-- this will no longer be supported in pyScss 2.0".format(cont)
                )
            )
                ...
                def _av(m):
                    ...
                    try:
                        ...
                        if self.undefined_variables_fatal:
                            ...
                            log.error(
                                "Undefined variable '%s'", n, extra={"stack": True}
                            )
                            return n
                    else:
                        if v:
                            if not isinstance(v, Value):
                                raise TypeError(
                                    ...
                                    "with a non-Sass value: {1!r}".format(n, v)
                                )
                            v = v.render()
        ...
        if isinstance(expr, six.text_type):
            ...
            warn(
                FutureWarning(
                    ...
                    "-- this will no longer be supported in pyScss 2.0".format(expr)
                )
            )
