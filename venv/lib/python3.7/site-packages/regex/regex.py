...
def match(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, kwargs).match(
...
def fullmatch(
    ...
    **kwargs
    ...
    object, or None if no match was found."""
    return _compile(pattern, flags, kwargs).fullmatch(
        string, pos, endpos, concurrent, partial, timeout
    )
...
def search(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, kwargs).search(
        string, pos, endpos, concurrent, partial, timeout
    )
...
def sub(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, kwargs).sub(
...
def subf(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, kwargs).subf(
...
def subn(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, kwargs).subn(
        repl, string, count, pos, endpos, concurrent, timeout
    )
...
def subfn(
    ...
    **kwargs
    ...
    replacement string to be used."""
    return _compile(pattern, flags, kwargs).subfn(
        format, string, count, pos, endpos, concurrent, timeout
    )


def split(
    pattern, string, maxsplit=0, flags=0, concurrent=None, timeout=None, **kwargs
):
...
def findall(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, kwargs).findall(
...
def finditer(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, kwargs).finditer(
