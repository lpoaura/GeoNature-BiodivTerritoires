...
class AssetsExtension(Extension):
    ...
    def __init__(self, environment):
        ...
        environment.extend(assets_environment=None,)
    ...
    def parse(self, parser):
        ...
        while parser.stream.current.type != "block_end":
            ...
            if parser.stream.current.test("name") and parser.stream.look().test(
                "assign"
            ):
        ...
        args = [nodes.Name("ASSET_URL", "param"), nodes.Name("EXTRA", "param")]
    ...
    def _render_assets(self, filter, output, dbg, depends, files, caller=None):
        ...
        if env is None:
            raise RuntimeError(
                "No assets environment configured in " + "Jinja2 environment"
            )
...
class Jinja2Loader(GlobLoader):
    ...
    def __init__(
        self, assets_env, directories, jinja2_envs, charset="utf8", jinja_ext="*.html"
    ):
