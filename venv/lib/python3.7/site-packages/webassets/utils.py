...
def make_option_resolver(
    clazz=None, attribute=None, classes=None, allow_none=True, desc=None
):
    ...
    def resolve_option(option, env=None):
        the_clazz = (
            clazz() if callable(clazz) and not isinstance(option, type) else clazz
        )
