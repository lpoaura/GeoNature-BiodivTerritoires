...
class CursorTests(ConnectingTestCase):
    ...
    def test_bad_placeholder(self):
        ...
        self.assertRaises(
            psycopg2.ProgrammingError, cur.mogrify, "select %(foo, %(bar)", {"foo": 1}
        )
        self.assertRaises(
    ...
    def test_scroll(self):
        ...
        self.assertRaises(
            (IndexError, psycopg2.ProgrammingError), cur.scroll, -1, mode="absolute"
        )
        cur.scroll(0, mode="absolute")
        ...
        self.assertRaises(
            (IndexError, psycopg2.ProgrammingError), cur.scroll, 10, mode="absolute"
        )
        cur.scroll(9, mode="absolute")
        self.assertRaises((IndexError, psycopg2.ProgrammingError), cur.scroll, 1)
