...
class LargeObjectTests(LargeObjectTestCase):
    ...
    def test_read_large(self):
        ...
        self.assertTrue(data == data1, "%r... != %r..." % (data[:100], data1[:100]))
...
decorate_all_tests(
    LargeObjectTruncateTests, skip_if_no_lo, skip_lo_if_green, skip_if_no_truncate
)
...
def _has_lo64(conn):
    ...
    if conn.server_version < 90300:
        return (
            False,
            "server version %s doesn't support the lo64 API" % conn.server_version,
        )
