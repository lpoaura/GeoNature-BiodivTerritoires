...
class PGDialect(default.DefaultDialect):
    ...
    def get_columns(self, connection, table_name, schema=None, **kw):
        ...
        for (name, format_type, default_, notnull, attnum, table_oid, comment,) in rows:
            column_info = self._get_column_info(
                name, format_type, default_, notnull, domains, enums, schema, comment,
            )
    ...
    def get_check_constraints(self, connection, table_name, schema=None, **kw):
        ...
        return [
            {"name": name, "sqltext": match_cons(src)} for name, src in c.fetchall()
        ]
