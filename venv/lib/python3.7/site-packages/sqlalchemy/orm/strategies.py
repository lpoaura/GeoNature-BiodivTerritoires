...
class JoinedLoader(AbstractRelationshipLoader):
    ...
    def _create_eager_join(
        ...
        towrap = context.eager_joins.setdefault(query_entity_key, default_towrap)
    ...
    def create_row_processor(
        ...
        if eager_adapter is not False:
            ...
            _instance = loading._instance_processor(
                self.mapper, context, result, our_path[self.entity], eager_adapter,
            )
        ...
        if self.omit_join:
            ...
            q.add_criteria(
                lambda q: q.select_from(pa).join(
                    getattr(pa, self.parent_property.key).of_type(effective_entity)
                )
            )
