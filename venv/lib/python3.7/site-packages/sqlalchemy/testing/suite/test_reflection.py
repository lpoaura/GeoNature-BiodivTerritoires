...
class ComponentReflectionTest(fixtures.TablesTest):
    ...
    def _test_get_foreign_key_options(self, **options):
        ...
        Table(
            "x", meta, Column("id", Integer, primary_key=True), test_needs_fk=True,
        )
    ...
    def test_reflect_expression_based_indexes(self):
        Table(
            "t", self.metadata, Column("x", String(30)), Column("y", String(30)),
        )
        event.listen(
            self.metadata,
            "after_create",
        ...
        event.listen(self.metadata, "after_create", DDL("CREATE INDEX t_idx_2 ON t(x)"))
