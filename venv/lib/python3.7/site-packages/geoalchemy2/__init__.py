from .types import Geometry, Geography, Raster  # NOQA

from .elements import WKTElement, WKBElement, RasterElement  # NOQA
    ...
    def dispatch(event, table, bind):
        if event in ("before-create", "before-drop"):
            ...
            if event == "before-drop":
                ...
                for c in gis_cols:
                    stmt = select(
                        [func.DropGeometryColumn(table_schema, table.name, c.name)]
                    )
            ...
            for c in table.c:
                ...
                if (
                    isinstance(c.type, (Geometry, Geography))
