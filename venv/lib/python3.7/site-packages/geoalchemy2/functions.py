...
_FUNCTIONS = [
    ...
    ("ST_GeometryType", None, "Return the geometry type of the ``ST_Geometry`` value."),
    ("ST_IsValid", None, "Returns ``True`` if the ``ST_Geometry`` is well formed."),
    ("ST_NPoints", None, "Return the number of points (vertices) in a geometry."),
    (
        "ST_SRID",
        None,
    ...
    ("ST_Width", None, ("Returns the width of the raster in pixels.", "RT_ST_Width")),
    #
    ...
    (
        ...
        (
            ...
            "in then reads it from metadata of raster.",
            "RT_ST_Value",
        ),
    ),
]
