...
def dump(obj, fp, cls=GeoJSONEncoder, allow_nan=False, **kwargs):
    return json.dump(to_mapping(obj), fp, cls=cls, allow_nan=allow_nan, **kwargs)


def dumps(obj, cls=GeoJSONEncoder, allow_nan=False, **kwargs):
    return json.dumps(to_mapping(obj), cls=cls, allow_nan=allow_nan, **kwargs)
...
def load(
    ...
    **kwargs
    ...
    return json.load(
        fp, cls=cls, object_hook=object_hook, parse_constant=parse_constant, **kwargs
    )
...
def loads(
    ...
    **kwargs
    ...
    return json.loads(
        s, cls=cls, object_hook=object_hook, parse_constant=parse_constant, **kwargs
    )
