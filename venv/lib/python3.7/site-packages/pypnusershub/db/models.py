...
class User(db.Model):
    ...
    TABLE_ID = Sequence("t_roles_id_seq", schema="utilisateurs",)
    groupe = db.Column(db.Boolean, default=False)
    id_role = db.Column(db.Integer, TABLE_ID, primary_key=True,)
...
class Application(db.Model):
    ...
    def get_application(nom_application):
        return Application.query.filter(
            Application.nom_application == nom_application
        ).one()
...
class AppUser(db.Model):
    ...
    def as_dict(self):
        cols = (
            ...
            if (c.name != "pass_plus") and (c.name != "pass")
        )
