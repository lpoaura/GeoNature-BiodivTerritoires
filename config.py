...
SQLALCHEMY_DATABASE_URI = "postgresql://fcloitre:Philogas80@crashtest:5432/gn2dev"
...
SITE_DESC = (
    "Une plateforme de porter à connaissance de la <b>biodiversité</b> des territoires"
)
